...
from gateway.data import bundles as bundles_module
from gateway.utils.calendars.calendar_utils import get_calendar
from gateway.utils.compat import wraps
from gateway.utils.cli import Date, Timestamp
from gateway.utils.run_algo import _run, load_extensions
...
@click.option(
    ...
    '--extension',
    multiple=True,
    help='File or module path to a gateway extension to load.',
)
@click.option(
    '--strict-extensions/--non-strict-extensions',
    is_flag=True,
    help='If --strict-extensions is passed then gateway will not run if it'
...
@click.option(
    ...
    is_flag=True,
    default=True,
    help="Don't load the default gateway extension.py file in $GATEWAY_HOME.",
)
def main(extension, strict_extensions, default_extension):
    """Top level gateway entry point.
    """
...
def gateway_magic(line, cell=None):
    """The gateway IPython cell magic.
    """
    load_extensions(
        default=True,
        extensions=[],
