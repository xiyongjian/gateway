...
from gateway.pipeline.mixins import SingleInputMixin
from gateway.utils.input_validation import expect_bounded
...
from gateway.utils.numpy_utils import rolling_window
...
class BollingerBands(CustomFactor):
    ...
    **Default Inputs:** :data:`gateway.pipeline.data.USEquityPricing.close`
...
class FastStochasticOscillator(CustomFactor):
    ...
    **Default Inputs:** :data: `gateway.pipeline.data.USEquityPricing.close`
                        :data: `gateway.pipeline.data.USEquityPricing.low`
                        :data: `gateway.pipeline.data.USEquityPricing.high`
...
class IchimokuKinkoHyo(CustomFactor):
    ...
    **Default Inputs:** :data:`gateway.pipeline.data.USEquityPricing.high`
                        :data:`gateway.pipeline.data.USEquityPricing.low`
                        :data:`gateway.pipeline.data.USEquityPricing.close`
