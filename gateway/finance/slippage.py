...
from gateway.errors import HistoryWindowStartsBeforeData
from gateway.finance.constants import ROOT_SYMBOL_TO_ETA
from gateway.finance.shared import AllowedAssetMarker, FinancialModelMeta
from gateway.finance.transaction import create_transaction
from gateway.utils.cache import ExpiringCache
from gateway.utils.dummy import DummyMapping
...
def fill_price_worse_than_limit_price(fill_price, order):
    ...
    order: gateway.finance.order.Order
