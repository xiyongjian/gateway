...
from gateway.data._resample import (
...
from gateway.data.bar_reader import NoDataOnDate
from gateway.data.minute_bars import MinuteBarReader
...
class ReindexBarReader(with_metaclass(ABCMeta)):
    ...
    - trading_calendar : gateway.utils.trading_calendar.TradingCalendar
