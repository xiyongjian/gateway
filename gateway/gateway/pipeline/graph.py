...
from gateway.pipeline.visualize import display_graph
...
class TermGraph(object):
    ...
    def _decref_depencies_recursive(self, term, refcounts, garbage):
        ...
        should use:
        :meth:`~gateway.pipeline.graph.TermGraph.decref_dependencies`
        """
...
class ExecutionPlan(TermGraph):
    ...
    def offset(self):
        ...
        See Also
        --------
        gateway.pipeline.graph.TermGraph.offset
        gateway.pipeline.engine.SimplePipelineEngine._inputs_for_term
        gateway.pipeline.engine.SimplePipelineEngine._mask_and_dates_for_term
        """
    ...
    def extra_rows(self):
        ...
        **as an input**.  This is not to be confused with `term.dependencies`,
        ...
        --------
        gateway.pipeline.graph.TermGraph.offset
        gateway.pipeline.term.Term.dependencies
        """
        return {
