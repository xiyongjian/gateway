...
from gateway.pipeline.classifiers import Classifier, Latest as LatestClassifier
from gateway.pipeline.factors import Factor, Latest as LatestFactor
from gateway.pipeline.filters import Filter, Latest as LatestFilter
from gateway.pipeline.sentinels import NotSpecified
from gateway.pipeline.term import (
    AssetExists,
    LoadableTerm,
    validate_dtype,
)
from gateway.utils.input_validation import ensure_dtype
from gateway.utils.numpy_utils import NoDefaultMissingValue
...
class BoundColumn(LoadableTerm):
    ...
    latest : gateway.pipeline.data.Factor or gateway.pipeline.data.Filter
    ...
    dataset : gateway.pipeline.data.DataSet
