...
from gateway.lib.adjusted_array import can_represent_dtype
...
from gateway.utils.sharedoc import (
    templated_docstring,
...
class AssetExists(Term):
    ...
    See Also
    --------
    gateway.assets.AssetFinder.lifetimes
    """
    dtype = bool_dtype
    dataset = None
    inputs = ()
...
class LoadableTerm(Term):
    ...
    This is the base class for :class:`gateway.pipeline.data.BoundColumn`.
    """
    windowed = False
    inputs = ()
...
class ComputableTerm(Term):
    ...
    This is the base class for :class:`gateway.pipeline.Factor`,
    :class:`gateway.pipeline.Filter`, and :class:`gateway.pipeline.Classifier`.
    """
    inputs = NotSpecified
...
class Slice(ComputableTerm):
    ...
    Parameters
    ----------
    term : gateway.pipeline.term.Term
