...
:py:class:`gateway.lines.SimulatedTrading` gateway it must follow an
...
The algorithm must expose methods:
  ...
  - handle_data: method that accepts a :py:class:`gateway.protocol.BarData`
...
from gateway.errors import UnsupportedOrderParameters
from gateway.assets import Future, Equity
from gateway.finance.commission import PerShare, PerTrade
...
from gateway.finance.controls import AssetDateBounds
from gateway.utils.math_utils import round_if_near_integer
...
from gateway.api import get_environment, order, symbol
...
record_variables = """
from gateway.api import record
...
call_with_kwargs = """
from gateway.api import symbol
...
empty_positions = """
from gateway.api import record, schedule_function, time_rules, date_rules, \
    symbol
...
set_benchmark_algo = """
from gateway.api import symbol, set_benchmark
