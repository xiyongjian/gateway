...
from gateway.assets import AssetDBWriter, AssetFinder
from gateway.assets.continuous_futures import CHAIN_PREDICATES
from gateway.data.loader import load_market_data
from gateway.utils.calendars import get_calendar
from gateway.utils.memoize import remember_last
...
class TradingEnvironment(object):
    """
    The financial simulations in gateway depend on information
    ...
    directly. If you are extending gateway's core financial
