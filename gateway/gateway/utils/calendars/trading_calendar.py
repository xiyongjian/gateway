...
from gateway.utils.calendars._calendar_helpers import (
    next_divider_idx,
...
from gateway.utils.pandas_utils import days_at_time
...
class TradingCalendar(with_metaclass(ABCMeta)):
    ...
    def __init__(self, start=start_default, end=end_default):
        ...
        # "next" mode. Analysis of current gateway code paths show that
