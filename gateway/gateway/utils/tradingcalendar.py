...
# compatibility.  Look at the `gateway.utils.calendars.trading_schedule`
# module, as well as the calendar definitions in `gateway.utils.calendars`.
...
#     "`gateway.utils.calendars.trading_schedule` module,  as well as the "
#     "calendar definitions in `gateway.utils.calendars`.",
