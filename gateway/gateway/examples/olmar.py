...
from gateway.finance import commission

gateway_logging = logbook.NestedSetup([
    logbook.NullHandler(),
    logbook.StreamHandler(sys.stdout, level=logbook.INFO),
    logbook.StreamHandler(sys.stderr, level=logbook.ERROR),
])
gateway_logging.push_application()
...
def _test_args():
    """Extra arguments to use when gateway's automated tests run this example.
    """
    import pandas as pd
