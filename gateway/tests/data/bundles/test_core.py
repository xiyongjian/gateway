...
from gateway.assets import ASSET_DB_VERSION

from gateway.assets.asset_writer import check_version_info
from gateway.assets.synthetic import make_simple_equity_info
from gateway.data.bundles import UnknownBundle, from_bundle_ingest_dirname, \
    ingestions_for_bundle
from gateway.data.bundles.core import _make_bundle_core, BadClean, \
    to_bundle_ingest_dirname, asset_db_path
from gateway.lib.adjustment import Float64Multiply
...
from gateway.testing.fixtures import WithInstanceTmpDir, GatewayTestCase, \
    WithDefaultDateBounds
from gateway.testing.predicates import (
    assert_equal,
    assert_false,
    assert_in,
    assert_is,
...
from gateway.utils.calendars import TradingCalendar, get_calendar
import gateway.utils.paths as pth
...
class BundleCoreTestCase(WithInstanceTmpDir,
    ...
    def init_instance_fixtures(self):
        ...
        self.environ = {'GATEWAY_ROOT': self.instance_tmpdir.path}
