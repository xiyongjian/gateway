...
import gateway.finance.performance as perf
from gateway.finance.transaction import create_transaction
import gateway.utils.math_utils as zp_math

from gateway.finance.blotter import Order
from gateway.finance.performance.position import Position
from gateway.utils.factory import create_simulation_parameters
from gateway.utils.serialization_utils import (
...
class TestSplitPerformance(WithSimParams, WithTmpDir, GatewayTestCase):
