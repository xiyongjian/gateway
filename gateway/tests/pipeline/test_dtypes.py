...
from gateway.pipeline import CustomClassifier, CustomFactor, CustomFilter
...
from gateway.utils.numpy_utils import int64_dtype, bool_dtype
...
class DtypeTestCase(GatewayTestCase):
