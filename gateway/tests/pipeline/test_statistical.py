...
from gateway.assets import Equity
from gateway.errors import IncompatibleTerms, NonExistentAssetInTimeFrame
...
from gateway.pipeline.factors.statistical import vectorized_beta
...
class VectorizedBetaTestCase(GatewayTestCase):
