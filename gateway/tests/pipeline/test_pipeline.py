"""
Tests for gateway.pipeline.Pipeline
"""
import inspect
...
from gateway.pipeline import Factor, Filter, Pipeline
from gateway.pipeline.data import USEquityPricing
from gateway.pipeline.graph import display_graph
...
class PipelineTestCase(TestCase):
    ...
    def test_show_graph(self):
        ...
        patch_display_graph = patch(
            'gateway.pipeline.graph.display_graph',
            mock_display_graph,
        )
