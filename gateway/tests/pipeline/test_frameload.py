"""
Tests for gateway.pipeline.loaders.frame.DataFrameLoader.
"""
...
from gateway.pipeline.loaders.frame import (
    DataFrameLoader,
)
...
class DataFrameLoaderTestCase(TestCase):
    ...
    def test_adjustments(self):
        ...
        with patch('gateway.pipeline.loaders.frame.AdjustedArray') as m:
            loader.load_adjusted_array(
