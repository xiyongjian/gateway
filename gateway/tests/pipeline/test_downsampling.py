...
from gateway.pipeline.factors import SimpleMovingAverage
from gateway.pipeline.filters.smoothing import All
from gateway.testing import GatewayTestCase, parameter_space, ExplodingObject
from gateway.testing.fixtures import (
    WithTradingSessions,
    WithSeededRandomPipelineEngine,
    WithAssetFinder,
)
from gateway.utils.input_validation import _qualified_name
...
class ComputeExtraRowsTestCase(WithTradingSessions, GatewayTestCase):
...
class TestDownsampledRowwiseOperation(WithAssetFinder, GatewayTestCase):
