...
from gateway._protocol import handle_non_market_minutes, BarData
from gateway.assets import Asset, Equity
...
class MinuteEquityHistoryTestCase(WithHistory, GatewayTestCase):
    ...
    def test_history_in_initialize(self):
        algo_text = dedent(
            """\
            from gateway.api import history
...
class DailyEquityHistoryTestCase(WithHistory, GatewayTestCase):
