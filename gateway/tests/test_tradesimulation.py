...
from gateway.gens.sim_engine import BEFORE_TRADING_START_BAR
...
from gateway.test_algorithms import NoopAlgorithm
...
from gateway.testing.core import FakeDataPortal
...
class TestTradeSimulation(WithTradingEnvironment, GatewayTestCase):
