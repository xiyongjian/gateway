...
from gateway.testing.fixtures import WithTradingEnvironment, GatewayTestCase

from gateway.finance.risk.period import RiskMetricsPeriod
...
class TestRisk(WithTradingEnvironment, GatewayTestCase):
