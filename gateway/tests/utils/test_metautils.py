...
from gateway.utils.metautils import compose_types, with_metaclasses
...
class ComposeTypesTestCase(GatewayTestCase):
...
class WithMetaclassesTestCase(GatewayTestCase):
