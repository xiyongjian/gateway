...
"""
Tests for the gateway.finance package
"""
...
from gateway.finance.execution import MarketOrder, LimitOrder
from gateway.finance.performance import PerformanceTracker
from gateway.finance.trading import SimulationParameters
from gateway.data.us_equity_pricing import BcolzDailyBarReader
from gateway.data.minute_bars import BcolzMinuteBarReader
from gateway.data.data_portal import DataPortal
from gateway.data.us_equity_pricing import BcolzDailyBarWriter
from gateway.finance.slippage import FixedSlippage
...
class FinanceTestCase(WithLogger,
    ...
    def init_instance_fixtures(self):
        ...
        self.gateway_test_config = {'sid': 133}
...
class TradingEnvironmentTestCase(WithLogger,
                                 ...
                                 GatewayTestCase):
    """
    Tests for date management utilities in gateway.finance.trading.
    """
