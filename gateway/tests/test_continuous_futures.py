...
from gateway.assets.continuous_futures import (
    OrderedContracts,
    delivery_predicate
)
...
from gateway.data.minute_bars import FUTURES_MINUTES_PER_DAY
from gateway.errors import SymbolNotFound
...
class RollFinderTestCase(WithBcolzFutureDailyBarReader, GatewayTestCase):
