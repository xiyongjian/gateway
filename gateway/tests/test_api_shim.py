...
history_algo = """
from gateway.api import sid, history
...
history_bts_algo = """
from gateway.api import sid, history, record
...
class TestAPIShim(WithCreateBarData,
    ...
    def test_old_new_data_api_paths(self):
        ...
        spot_value_meth = 'gateway.data.data_portal.DataPortal.get_spot_value'
        ...
        history_meth = 'gateway.data.data_portal.DataPortal.get_history_window'
    ...
    def test_sid_accessor(self):
        ...
        with warnings.catch_warnings(record=True) as w:
            ...
            warnings.simplefilter("default", GatewayDeprecationWarning)
            ...
            # GatewayDeprecationWarnings
            for warning in w:
                self.assertEqual(
                    GatewayDeprecationWarning,
                    warning.category
                )
                self.assertEqual(
    ...
    def test_iterate_data(self):
        with warnings.catch_warnings(record=True) as w:
            ...
            for idx, warning in enumerate(w):
                self.assertEqual(GatewayDeprecationWarning,
                                 warning.category)
    ...
    def test_history(self):
        with warnings.catch_warnings(record=True) as w:
            ...
            self.assertEqual(GatewayDeprecationWarning, w[0].category)
