...
from gateway.utils.memoize import lazyval
...
class NoTradeDataAvailable(GatewayError):
    pass
...
class InvalidBenchmarkAsset(GatewayError):
    msg = """
...
class WrongDataForTransform(GatewayError):
    """
...
class UnsupportedSlippageModel(GatewayError):
    """
...
class IncompatibleSlippageModel(GatewayError):
    """
...
class SetSlippagePostInit(GatewayError):
...
class SetCancelPolicyPostInit(GatewayError):
...
class RegisterTradingControlPostInit(GatewayError):
...
class RegisterAccountControlPostInit(GatewayError):
    # Raised if a user's script register's a trading control after initialize
    # has been run.
    msg = """
...
class UnsupportedCommissionModel(GatewayError):
    """
...
class IncompatibleCommissionModel(GatewayError):
    """
...
class UnsupportedCancelPolicy(GatewayError):
    """
...
class SetCommissionPostInit(GatewayError):
    """
...
class TransactionWithNoVolume(GatewayError):
    """
...
class TransactionWithWrongDirection(GatewayError):
    """
...
class TransactionWithNoAmount(GatewayError):
    """
...
class TransactionVolumeExceedsOrder(GatewayError):
    """
...
class UnsupportedOrderParameters(GatewayError):
    """
...
class CannotOrderDelistedAsset(GatewayError):
    """
...
class BadOrderParameters(GatewayError):
    """
...
class OrderDuringInitialize(GatewayError):
    """
...
class SetBenchmarkOutsideInitialize(GatewayError):
    """
...
class AccountControlViolation(GatewayError):
    """
...
class TradingControlViolation(GatewayError):
    """
...
class IncompatibleHistoryFrequency(GatewayError):
    """
...
class HistoryInInitialize(GatewayError):
    """
...
class OrderInBeforeTradingStart(GatewayError):
    """
...
class MultipleSymbolsFound(GatewayError):
    """
...
class SymbolNotFound(GatewayError):
    """
...
class RootSymbolNotFound(GatewayError):
    """
...
class ValueNotFoundForField(GatewayError):
    """
...
class MultipleValuesFoundForField(GatewayError):
    """
    Raised when a lookup_by_supplementary_mapping() call contains a
...
class NoValueForSid(GatewayError):
    """
...
class MultipleValuesFoundForSid(GatewayError):
    """
...
class SidsNotFound(GatewayError):
    """
...
class ConsumeAssetMetaDataError(GatewayError):
    """
...
class MapAssetIdentifierIndexError(GatewayError):
    """
...
class SidAssignmentError(GatewayError):
    """
...
class NoSourceError(GatewayError):
    """
...
class PipelineDateError(GatewayError):
    """
...
class WindowLengthTooLong(GatewayError):
    """
...
class WindowLengthNotPositive(GatewayError):
    """
...
class NonWindowSafeInput(GatewayError):
    """
...
class TermInputsNotSpecified(GatewayError):
    """
...
class TermOutputsEmpty(GatewayError):
    """
...
class InvalidOutputName(GatewayError):
    """
...
class WindowLengthNotSpecified(GatewayError):
    """
...
class InvalidTermParams(GatewayError):
    """
...
class DTypeNotSpecified(GatewayError):
    """
...
class UnsupportedDType(GatewayError):
    """
...
class BadPercentileBounds(GatewayError):
    """
...
class UnknownRankMethod(GatewayError):
    """
...
class AttachPipelineAfterInitialize(GatewayError):
    """
...
class PipelineOutputDuringInitialize(GatewayError):
    """
...
class NoSuchPipeline(GatewayError, KeyError):
    """
...
class DuplicatePipelineName(GatewayError):
    """
...
class UnsupportedDataType(GatewayError):
    """
...
class NoFurtherDataError(GatewayError):
    """
...
class UnsupportedDatetimeFormat(GatewayError):
    """
...
class AssetDBVersionError(GatewayError):
    """
    ...
    msg = (
        ...
        "database or updating your version of Gateway."
    )


class AssetDBImpossibleDowngrade(GatewayError):
    msg = (
...
class HistoryWindowStartsBeforeData(GatewayError):
    msg = (
...
class NonExistentAssetInTimeFrame(GatewayError):
    msg = (
...
class InvalidCalendarName(GatewayError):
    """
...
class CalendarNameCollision(GatewayError):
    """
...
class CyclicCalendarAlias(GatewayError):
    """
...
class ScheduleFunctionWithoutCalendar(GatewayError):
    """
...
class ScheduleFunctionInvalidCalendar(GatewayError):
    """
...
class UnsupportedPipelineOutput(GatewayError):
    """
