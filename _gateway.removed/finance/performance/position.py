...
from gateway.assets import Future, Asset
...
class Position(object):
    ...
    def adjust_commission_cost_basis(self, asset, cost):
        """
        A note about cost-basis in gateway: all positions are considered
        to share a cost basis, even if they were executed in different
        transactions with different commission costs, different prices, etc.

        Due to limitations about how gateway handles positions, gateway will
