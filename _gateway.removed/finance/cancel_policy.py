...
from gateway.gens.sim_engine import SESSION_END
    ...
    def should_cancel(self, event):
        ...
        event : enum-value
            An event type, one of:
              - :data:`gateway.gens.sim_engine.BAR`
              - :data:`gateway.gens.sim_engine.DAY_START`
              - :data:`gateway.gens.sim_engine.DAY_END`
              - :data:`gateway.gens.sim_engine.MINUTE_END`
...
class EODCancel(CancelPolicy):
    ...
    Gateway will only apply this policy to minutely simulations.
