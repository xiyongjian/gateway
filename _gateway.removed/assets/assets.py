...
from gateway.utils.functional import invert
from gateway.utils.memoize import lazyval
from gateway.utils.numpy_utils import as_column
from gateway.utils.preprocess import preprocess
from gateway.utils.sqlite_utils import group_into_chunks, coerce_string_to_eng
...
class AssetFinder(object):
    ...
    See Also
    --------
    :class:`gateway.assets.AssetDBWriter`
    """
    ...
    def lifetimes(self, dates, include_start_date):
        ...
        --------
        numpy.putmask
        gateway.pipeline.engine.SimplePipelineEngine._compute_root_mask
        """
