...
from gateway.lib.adjustment import make_adjustment_from_labels
...
class DataFrameLoader(PipelineLoader):
    ...
    Parameters
    ----------
    column : gateway.pipeline.data.BoundColumn
    ...
    adjustments : pandas.DataFrame, default=None
        A DataFrame with the following columns:
            sid : int
            value : any
            kind : int (gateway.pipeline.loaders.frame.ADJUSTMENT_TYPES)
