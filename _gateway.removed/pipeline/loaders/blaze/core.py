...
This module (gateway.pipeline.loaders.blaze) exports a function called
...
from gateway.pipeline.data.dataset import DataSet, Column
from gateway.pipeline.loaders.utils import (
...
from gateway.utils.pool import SequentialPool
...
class BlazeLoader(object):
    ...
    See Also
    --------
    :class:`gateway.utils.pool.SequentialPool`
    ...
    def register_dataset(self,
        ...
        See Also
        --------
        :func:`gateway.pipeline.loaders.blaze.from_blaze`
        """
        expr_data = ExprData(
            expr,
            deltas,
