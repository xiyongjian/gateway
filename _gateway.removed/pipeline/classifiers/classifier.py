...
from gateway.errors import UnsupportedDataType
from gateway.lib.labelarray import LabelArray
from gateway.lib.quantiles import quantiles
...
from gateway.pipeline.term import ComputableTerm
from gateway.utils.compat import unicode
from gateway.utils.input_validation import expect_types, expect_dtypes
...
class Relabel(SingleInputMixin, Classifier):
    ...
    Parameters
    ----------
    arg : gateway.pipeline.Classifier
...
class CustomClassifier(PositiveWindowLengthMixin,
    ...
    See Also
    --------
    gateway.pipeline.CustomFactor
    gateway.pipeline.CustomFilter
    """
    def _validate(self):
        try:
...
class Latest(LatestMixin, CustomClassifier):
    ...
    See Also
    --------
    gateway.pipeline.data.dataset.BoundColumn.latest
    gateway.pipeline.factors.factor.Latest
    gateway.pipeline.filters.filter.Latest
    """
    pass
