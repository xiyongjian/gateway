...
from gateway.data.session_bars import SessionBarReader
from gateway.data.bar_reader import (
    NoDataAfterDate,
    NoDataBeforeDate,
    NoDataOnDate,
)
from gateway.utils.calendars import get_calendar
from gateway.utils.functional import apply
from gateway.utils.preprocess import call
from gateway.utils.input_validation import (
    expect_element,
    preprocess,
    verify_indices_all_unique,
)
from gateway.utils.sqlite_utils import group_into_chunks, coerce_string_to_conn
from gateway.utils.memoize import lazyval
from gateway.utils.cli import maybe_show_progress
...
class BcolzDailyBarWriter(object):
    ...
    calendar : gateway.utils.calendar.trading_calendar
    ...
    See Also
    --------
    gateway.data.us_equity_pricing.BcolzDailyBarReader
    """
    _csv_dtypes = {
        'open': float64,
        'high': float64,
...
class BcolzDailyBarReader(SessionBarReader):
    ...
    See Also
    --------
    gateway.data.us_equity_pricing.BcolzDailyBarWriter
    """
...
class SQLiteAdjustmentWriter(object):
    ...
    See Also
    --------
    gateway.data.us_equity_pricing.SQLiteAdjustmentReader
    """
...
class SQLiteAdjustmentReader(object):
    ...
    See Also
    --------
    :class:`gateway.data.us_equity_pricing.SQLiteAdjustmentWriter`
    """
