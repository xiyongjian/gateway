...
from gateway.data.continuous_future_reader import (
    ContinuousFutureSessionBarReader,
    ContinuousFutureMinuteBarReader
)
from gateway.assets.roll_finder import (
    CalendarRollFinder,
    VolumeRollFinder
)
from gateway.data.dispatch_bar_reader import (
    AssetDispatchMinuteBarReader,
    AssetDispatchSessionBarReader
)
from gateway.data.resample import (
    DailyHistoryAggregator,
    ReindexMinuteBarReader,
    ReindexSessionBarReader,
)
from gateway.data.history_loader import (
    DailyHistoryLoader,
    MinuteHistoryLoader,
)
from gateway.data.us_equity_pricing import NoDataOnDate
from gateway.utils.math_utils import (
    nansum,
    nanmean,
    nanstd
)
from gateway.utils.memoize import remember_last, weak_lru_cache
from gateway.utils.pandas_utils import timedelta_to_integral_minutes
...
class DataPortal(object):
    """Interface to all of the data that a gateway simulation needs.
    ...
    Parameters
    ----------
    asset_finder : gateway.assets.assets.AssetFinder
        The AssetFinder instance used to resolve assets.
    trading_calendar: gateway.utils.calendar.exchange_calendar.TradingCalendar
    ...
    def get_history_window(self,
        ...
        Parameters
        ----------
        assets : list of gateway.data.Asset objects
