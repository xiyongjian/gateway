...
from gateway.utils.calendars import register_calendar_alias
...
def csvdir_equities(tframes=None, csvdir=None):
    ...
    This function can be used in ~/.gateway/extension.py
    ...
    Examples
    --------
    This code should be added to ~/.gateway/extension.py
    .. code-block:: python
       from gateway.data.bundles import csvdir_equities, register
...
def csvdir_bundle(environ,
                  ...
                  csvdir=None):
    """
    Build a gateway data bundle from the directory with csv files.
    """
    if not csvdir:
