...
from gateway.utils.calendars import TradingCalendar
from gateway.utils.calendars.trading_calendar import (
    HolidayCalendar, end_default
)
from gateway.utils.calendars.us_holidays import (
    USNewYearsDay,
    Christmas
)
...
class QuantopianUSFuturesCalendar(TradingCalendar):
    ...
    calendars provided by Gateway (CFE, CME, ICE), and is intended for
    ...
    # since it has the most total minutes of any of the gateway calendars.
    def __init__(self,
